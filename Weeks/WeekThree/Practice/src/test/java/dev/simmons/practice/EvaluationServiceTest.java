...
public class EvaluationServiceTest {
    ...
    public void cleansNumbersWithCountryCode() {
        ...
        String actualNumber = evaluationService.cleanPhoneNumber("+1 (223)456-7890");
        assertEquals(expectedNumber, actualNumber);
        actualNumber = evaluationService.cleanPhoneNumber("+1(223)456-7890");
        assertEquals(expectedNumber, actualNumber);
        actualNumber = evaluationService.cleanPhoneNumber("1 (223)456-7890");
        assertEquals(expectedNumber, actualNumber);
        actualNumber = evaluationService.cleanPhoneNumber("1(223)456-7890");
        assertEquals(expectedNumber, actualNumber);
        //actualNumber = evaluationService.cleanPhoneNumber("123-456-7890");
        //assertEquals("1234567890", actualNumber);
    }
    ...
    public void checkDigitIsACharacterOtherThanX() {
        ...
        assertFalse(evaluationService.isValidIsbn("3-598-21507-B"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-C"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-D"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-E"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-F"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-G"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-H"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-I"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-J"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-K"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-L"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-M"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-N"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-O"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-P"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-Q"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-R"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-S"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-T"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-U"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-V"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-W"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-Y"));
        assertFalse(evaluationService.isValidIsbn("3-598-21507-Z"));
    }
